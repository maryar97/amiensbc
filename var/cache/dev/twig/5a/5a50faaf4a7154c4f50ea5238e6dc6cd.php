     ...
     <div class=\"card-body\"> <div class=\"row align-items-center\">
       ...
       <div class=\"col-4\" ></div>
          ...
          <button type=\"button\" class=\"btn btn-light\" li class=\"nav-item\">
            ...
            // line 20
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("cart_add", ["id" => twig_get_attribute($this->env, $this->source, $context["forme"], "id", [], "any", false, false, false, 20)]), "html", null, true);
            echo "\">prendre ma licence </a></button>
...
<div class=\"card mb-3 \" with=\"auto\">
     <div class=\"card-body\"> <div class=\"row align-items-center\">
       ...
       <div class=\"col-4\" ></div>
          ...
          <button type=\"button\" class=\"btn btn-light\" li class=\"nav-item\">
                    <a class=\"nav-link\" href=\"{{path('cart_add',{'id':forme.id})}}\">prendre ma licence </a></button>
...
{% endfor %}
{% endblock %}
", "bea/index.html.twig", "/home/lulu/Bureau/amiens/amiensbc/templates/bea/index.html.twig");
    }
}
